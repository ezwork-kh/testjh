...
<head>
 <style>
   ...
   form{margin:0;width:80%; text-align:center}
   select{color:#495057; background-color:#fff; background-clip:padding-box; border:1px solid #ced4da; border-radius:.25rem; 
...
<form action="member_list.net">
	<div class="input-group">
	  ...
	  <input name="search_word" type="text" class="form-control" placeholder="아이디를 입력하세요" value="${search_word}">
      ...
      <div class="row">
		<div class="col">
		  <ul class="pagination">		
			 <c:if test="${page <= 1}">
				<li class="page-item">
				  <a class="page-link current">이전&nbsp;</a>
				</li>
			 </c:if>
			 <c:if test="${page > 1}">			
				<li class="page-item">
