...
public class CommentController {
	...
	/*
	 * @ResponseBody란?
	 * 메서드에 @ResponseBody Annotation이 되어 있으면 return되는 값이 View를 통해서 
	 ...
	 * 이 중에서 자바 객체를 JSON 응답 바디로 변환할 때는 MappingJackson2HttpMessageConverter를 사용한다.
	 
	 * @ResponseBody를 이용해서 각 메서드의 실행 결과는 JSON으로 변환되어 HTTP Response BODY에 설정된다.	 	
	 */
	@ResponseBody
